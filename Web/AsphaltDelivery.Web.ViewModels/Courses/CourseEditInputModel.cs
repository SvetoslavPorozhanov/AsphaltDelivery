namespace AsphaltDelivery.Web.ViewModels.Courses
{
    ...
    public class CourseEditInputModel : IMapTo<EditCourseServiceModel>, IMapFrom<EditCourseServiceModel>, IHaveCustomMappings
    {
        ...
        {
            configuration.CreateMap<CourseEditInputModel, EditCourseServiceModel>()
                .ForMember(
            ...
            configuration.CreateMap<EditCourseServiceModel, CourseEditInputModel>()
                .ForMember(
                    destination => destination.DateTime,
