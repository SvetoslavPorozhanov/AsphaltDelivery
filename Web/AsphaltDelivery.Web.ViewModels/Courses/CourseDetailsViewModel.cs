namespace AsphaltDelivery.Web.ViewModels.Courses
{
    ...
    public class CourseDetailsViewModel : IMapFrom<DetailsCourseServiceModel>, IHaveCustomMappings
    {
        ...
        {
            configuration.CreateMap<DetailsCourseServiceModel, CourseDetailsViewModel>()
                .ForMember(
